...
# Name: Dania Danyliuk, КМ-13
# Collaborators: Dania Danyliuk
# Time spent: 6 days and 6 nights
    ...
    while True:
        ...
        if is_word_guessed(secret_word, last_guessed):
            if secret_word == ''.join(result.split(' ')):
                print(f'Congatulations!!! {N_guesses} guesses left! Good game =)')
                print(f'{secret_word}')
                break
            else:
            ...
            if last_guessed in "aeoiu":
                N_guesses -= 1
            N_guesses = N_guesses - 1
            if N_guesses <= 0:
                print(f'You lose, you have nothing guesses. Word was:')
                print(f'{secret_word}')
                break
            else:
                continue
            ...
            if N_warnings > 0:
                ...
                print(f'Oops!!!')
                print(f'You lose, you have nothing. Word was: ')
                print(f'{secret_word}')
                break

        if N_guesses < 0:
            print('You lose, you have nothing = ( Word was: ')
            print(f'{secret_word}')
            break
    ...
    * If the guess is the symbol *, print out all words in wordlist that
    ...
    while True:
        ...
        if letters == "*":
            ...
            if secret_word == ''.join(result.split(' ')):
                print(f'Congats!!! {N_guesses} guesses left! Good game!!)')
                print(f'{secret_word}')
                break
            else:
                print(f'Good guess: {result}')
